...
public class BOJ_1107 {
	public static void main(String[] args) {
		...
		int targetLength = targetNum.length(); // 4 .. 10*3 부터 나눈다. 목표 채널의 자릿수
...
//		System.out.println(Arrays.toString(num));
		...
		defaultCnt = Math.abs(target - 100);
		...
		pushCnt = Math.min(defaultCnt, pushCnt);
		if (sb.charAt(0) == '0') {
